...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__help_help__ = __webpack_require__(22);
...
var LookupPlanPage = /** @class */ (function () {
    ...
    LookupPlanPage.prototype.getList = function () {
        if (this.searchingMaster) {
            this.getMasterList();
        }
        else {
    ...
    LookupPlanPage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_2__providers_master_plans_master_plans__["a" /* MasterPlansProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_master_plans_master_plans__["a" /* MasterPlansProvider */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__providers_personal_plans_personal_plans__["a" /* PersonalPlansProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__providers_personal_plans_personal_plans__["a" /* PersonalPlansProvider */]) === "function" && _e || Object])
    ], LookupPlanPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__local_store_local_store__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__hhapi_hhapi__ = __webpack_require__(72);
...
var AuthenticationProvider = /** @class */ (function () {
    function AuthenticationProvider(hhapi, http, iap, plt, LSP) {
        this.hhapi = hhapi;
        this.http = http;
        this.iap = iap;
        this.plt = plt;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        path = this.hhapi.apiURL + "user/" + user + "?p=" + pwd;
                        if ((!user) || (!pwd)) {
                            return [2 /*return*/, false];
                        }
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.hhapi.getData(path)];
                    case 2:
                        data = _a.sent();
                        if (!!data) {
                            d = JSON.parse(data);
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (purchases.length > 0) {
                            myTypes_1 = ['HHCPSubMonthly', 'hhcpsubmonthly'];
    ...
    AuthenticationProvider.prototype.createSubscription = function (productId) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            var api = _this.hhapi.apiURL + "user/" + _this.user.trim();
    ...
    AuthenticationProvider.prototype.checkUser = function (user) {
        ...
        return new Promise(function (resolve) {
            ...
            var api = _this.hhapi.apiURL + "user/" + user;
            _this.http.head(api)
    ...
    AuthenticationProvider = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__hhapi_hhapi__["a" /* HHAPI */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__help_help__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__help_help__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__help_help__ = __webpack_require__(22);
...
var EditGoalPage = /** @class */ (function () {
    ...
    EditGoalPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-edit-goal',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/edit-goal/edit-goal.html"*/'<ion-header>\n\n  <ion-navbar class="navbarStyle" color="primary">\n    <ion-title>Outcome</ion-title>\n    <ion-buttons end>\n      <button ion-button *ngIf="!auth.userLoggedIn" (click)="login()">\n        <ion-icon name="unlock"></ion-icon>\n      </button>\n      <button ion-button *ngIf="auth.userLoggedIn" (click)="logout()">\n        <ion-icon name="lock"></ion-icon>\n      </button>\n      <button ion-button (click)="help()">\n        <ion-icon name="help"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <p class="helpful">Changing an Outcome in {{plan.name}}\n  </p>\n  <br>\n  <ion-item>\n    <ion-textarea rows=4 type="text" placeholder="Describe the outcome here" [(ngModel)]="goal.text">\n    </ion-textarea>\n  </ion-item>\n  <ion-item>\n    <p class="hint">{{goal.hint}}</p>\n  </ion-item>\n  <ion-list radio-group [(ngModel)]="goal.term">\n    <ion-item>\n      <ion-label>Short Term</ion-label>\n      <ion-radio checked="true" value="ST"></ion-radio>\n    </ion-item>\n    <ion-item>\n      <ion-label>Long Term</ion-label>\n      <ion-radio value="LT"></ion-radio>\n    </ion-item>\n    <ion-item>\n      <ion-label>Not Applicable</ion-label>\n      <ion-radio value=""></ion-radio>\n    </ion-item>\n  </ion-list>\n  <button ion-button [disabled]="!goal.text" (click)="editDone()">Save</button>\n  <button ion-button (click)="cancelEdit()">Cancel</button>\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/edit-goal/edit-goal.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__help_help__ = __webpack_require__(22);
...
var AddProblemPage = /** @class */ (function () {
    ...
    AddProblemPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-add-problem',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/add-problem/add-problem.html"*/'<ion-header>\n\n\n\n  <ion-navbar class="navbarStyle" color="primary">\n\n    <ion-title>Add A Care Topic</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button *ngIf="!auth.userLoggedIn" (click)="login()">\n\n        <ion-icon name="unlock"></ion-icon>\n\n      </button>\n\n      <button ion-button *ngIf="auth.userLoggedIn" (click)="logout()">\n\n        <ion-icon name="lock"></ion-icon>\n\n      </button>\n\n      <button ion-button (click)="help()">\n\n        <ion-icon name="help"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n  <p class="helpful">Adding a Care Topic to {{plan.name}}\n\n  </p>\n\n  <br>\n\n  <button ion-button icon-left *ngIf="auth.userLoggedIn" (click)="lookupMaster()">\n\n    <ion-icon name="add"></ion-icon>\n\n    Add from the Red Book\n\n  </button>\n\n  <button ion-button icon-left *ngIf="!auth.userLoggedIn" (click)="login()">\n\n    <ion-icon name="lock"></ion-icon>\n\n    Log In to Add from the Red Book\n\n  </button>\n\n\n\n  <ion-item>\n\n    <ion-textarea rows=4 type="text" placeholder="Topic: focus or aspect of care" [(ngModel)]="problem.text">\n\n    </ion-textarea>\n\n  </ion-item>\n\n  <ion-item>\n\n    <p class="hint">{{problem.hint}}</p>\n\n  </ion-item>\n\n  <button ion-button [disabled]="!problem.text" (click)="editDone()">Save</button>\n\n  <button ion-button (click)="cancelEdit()">Cancel</button>\n\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/add-problem/add-problem.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
var AddInterventionPage = /** @class */ (function () {
    ...
    AddInterventionPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-add-intervention',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/add-intervention/add-intervention.html"*/'<ion-header>\n\n\n\n  <ion-navbar class="navbarStyle" color="primary">\n\n    <ion-title>Add Intervention</ion-title>\n\n    <ion-buttons end>\n\n      <button ion-button *ngIf="!auth.userLoggedIn" (click)="login()">\n\n        <ion-icon name="unlock"></ion-icon>\n\n      </button>\n\n      <button ion-button *ngIf="auth.userLoggedIn" (click)="logout()">\n\n        <ion-icon name="lock"></ion-icon>\n\n      </button>\n\n      <button ion-button (click)="help()">\n\n        <ion-icon name="help"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <p class="helpful">Adding an Intervention to {{plan.name}}\n\n  </p>\n\n  <br>\n\n  <button ion-button icon-left *ngIf="auth.userLoggedIn" (click)="lookupMaster()">\n\n    <ion-icon name="add"></ion-icon>\n\n    Add from the Red Book\n\n  </button>\n\n  <button ion-button icon-left *ngIf="!auth.userLoggedIn" (click)="login()">\n\n    <ion-icon name="lock"></ion-icon>\n\n    Log In to Add from the Red Book\n\n  </button>\n\n\n\n  <ion-item>\n\n    <ion-textarea rows=4 type="text" placeholder="Describe the intervention here" [(ngModel)]="intervention.text">\n\n    </ion-textarea>\n\n  </ion-item>\n\n  <ion-item>\n\n    <p class="hint">{{intervention.hint}}</p>\n\n  </ion-item>\n\n  <ion-list>\n\n    <ion-list-header>Discipline/Care Team for this Intervention:</ion-list-header>\n\n    <ion-item>\n\n      <ion-label>Nursing</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.nursing"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Occupational Therapy</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.OT"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Physical Therapy</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.PT"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Speech-language Pathology</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.speech"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Medical Social Work</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.social"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Aide</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.aide"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Pharmacist</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.pharmacist"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Dietician</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.dietician"></ion-checkbox>\n\n    </ion-item>\n\n    <ion-item>\n\n      <ion-label>Respiratory Therapy</ion-label>\n\n      <ion-checkbox [(ngModel)]="intervention.RT"></ion-checkbox>\n\n    </ion-item>\n\n  </ion-list>\n\n  <ion-item>\n\n    <ion-input type="text" placeholder="Other Discplines" [(ngModel)]="intervention.other">\n\n    </ion-input>\n\n  </ion-item>\n\n  <button ion-button [disabled]="!intervention.text" (click)="editDone()">Save</button>\n\n  <button ion-button (click)="cancelEdit()">Cancel</button>\n\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/add-intervention/add-intervention.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */],
...
var PlanMenuPage = /** @class */ (function () {
    ...
    PlanMenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-plan-menu',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/plan-menu/plan-menu.html"*/'<ion-content class="no-scroll">\n    <div style="color: red;" (click)="close(\'condition\')">\n      <ion-icon name="book"></ion-icon>\n      Add a Condition\n    </div>\n    <div style="color: red;" (click)="close(\'discipline\')">\n      <ion-icon name="book"></ion-icon>\n      Add a Discipline\n    </div>\n    <div (click)="close(\'myplan\')">\n      <ion-icon name="shuffle"></ion-icon>\n      Add from My Plan\n    </div>\n    <div style="color: red;" (click)="close(\'topic\')">\n      <ion-icon name="add"></ion-icon>\n      Add a Care Topic\n    </div>\n    <div (click)="close(\'share\')">\n      <ion-icon name="share"></ion-icon>\n       Share this Plan\n    </div>\n    <div (click)="close(\'delete\')">\n      <ion-icon name="trash"></ion-icon>\n       Delete this Plan\n    </div>\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/plan-menu/plan-menu.html"*/,
        }),
...
var TopicMenuPage = /** @class */ (function () {
    ...
    TopicMenuPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-topic-menu',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/topic-menu/topic-menu.html"*/'<ion-content class="no-scroll">\n  <div style="color: green;" (click)="close(\'goal\', p)">\n    <ion-icon name="star"></ion-icon>\n    Add an Outcome\n  </div>\n  <div style="color: blue;" (click)="close(\'intervention\', p)">\n    <ion-icon name="construct"></ion-icon>\n    Add an Intervention\n  </div>\n  <div (click)="close(\'delete\', p)">\n    <ion-icon name="trash"></ion-icon>\n    Delete this Topic\n  </div>\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/topic-menu/topic-menu.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ViewController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */]])
    ], TopicMenuPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_toast__ = __webpack_require__(51);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_personal_plans_personal_plans__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__help_help__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__help_help__ = __webpack_require__(22);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SamplePage = /** @class */ (function () {
    function SamplePage(navCtrl, auth) {
        ...
        this.itemsList = [
            ...
            { "text": "Musculoskeletal Rehabilitation Care" },
            { "text": "Neuro & Stroke Rehabilitation Care" },
...
var SampleDetailPage = /** @class */ (function () {
    ...
    SampleDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sample-detail',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/sample-detail/sample-detail.html"*/'<ion-header>\n\n  <ion-navbar class="navbarStyle" color="primary">\n    <ion-title>Sample Standard Plan</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <h2>Alzheimer\'s & Dementia</h2>\n  <!-- <h1 class="h1text">Alzheimer\'s & Dementia</h1> -->\n  <h1 class="h1text">Red Book Standard Care Plan</h1>\n  <div *ngFor="let p of samplePlan.problems">\n    <p class="ptext prob">{{p.text}}</p>\n    <div>\n      <div class="goal"><em>Outcomes</em></div>\n      <div *ngFor="let g of p.goals">\n        <label class="ptext goal"><em>{{g.term}}</em> {{g.text}}</label>\n      </div>\n      <div class="int"><em>Interventions</em></div>\n      <div *ngFor="let n of p.interventions">\n        <label class="ptext int">{{n.text}}</label>\n      </div>\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/sample-detail/sample-detail.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_crypto_js__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_crypto_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_crypto_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hhapi_hhapi__ = __webpack_require__(72);
...
var PersonalPlansProvider = /** @class */ (function () {
    function PersonalPlansProvider(http, events, conn, LSP, auth, hhapi, MPP) {
        this.http = http;
        this.events = events;
        this.conn = conn;
        this.LSP = LSP;
    ...
    PersonalPlansProvider.prototype.saveToWeb = function () {
        ...
        if (this.conn.internet) {
            ...
            var p = { plans: e };
            var api = this.hhapi.apiURL + "data/" + this.auth.user;
    ...
    PersonalPlansProvider.prototype.readFromWeb = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var api = _this.hhapi.apiURL + "data/" + _this.auth.user;
            try {
                _this.http.get(api)
                    .subscribe(function (data) {
    ...
    PersonalPlansProvider = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */],
            ...
            __WEBPACK_IMPORTED_MODULE_4__hhapi_hhapi__["a" /* HHAPI */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__hhapi_hhapi__ = __webpack_require__(72);
...
var MasterPlansProvider = /** @class */ (function () {
    function MasterPlansProvider(hhapi, auth, cache) {
        this.hhapi = hhapi;
        this.auth = auth;
        this.cache = cache;
        ...
        if (this.auth.userLoggedIn) {
            return new Promise(function (resolve) {
                ...
                _this.cache.read(type, MASTER_KEY, filter)
                    ...
                    var path = _this.hhapi.apiURL + "master/" + type;
                    if (filter) {
                        path = path + "?f=" + filter;
                    }
                    _this.hhapi.getData(path)
                        .then(function (data) {
    ...
    MasterPlansProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__hhapi_hhapi__["a" /* HHAPI */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__providers_hhapi_hhapi__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_help_help__ = __webpack_require__(22);
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__providers_hhapi_hhapi__["a" /* HHAPI */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__help_help__ = __webpack_require__(22);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WelcomePage = /** @class */ (function () {
    ...
    WelcomePage.prototype.gotoHelp = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_10__help_help__["a" /* HelpPage */]);
    };
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.iap.getProducts(['HHCPSubMonthly', 'hhcpsubmonthly'])];
                    case 1:
                        _a.products = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return HHAPI; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var HHAPI = /** @class */ (function () {
    function HHAPI(http) {
        this.http = http;
        this.apiURL = 'http://api.cpmez.com:33000/HomeHealth/';
    ...
    HHAPI.prototype.getData = function (type) {
        var _this = this;
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/app/app.html"*/
        }),
...
var LookupPage = /** @class */ (function () {
    ...
    LookupPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-lookup',template:/*ion-inline-start:"/mnt/F/Projects/CP/hhcp/src/pages/lookup/lookup.html"*/'<ion-header>\n\n  <ion-navbar class="navbarStyle" color="primary">\n    <ion-title>Select {{searchName}}</ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="help()">\n        <ion-icon name="help"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-navbar>\n\n</ion-header>\n\n<ion-content padding>\n  <p class="helpful">Searching the Red Book for {{searchName}}\n    to be added to {{planName}}\n  </p>\n  <br>\n  <ion-toolbar color=primary>\n    <ion-searchbar class="search" [(ngModel)]="searchTerm" debounce=1000 placeholder="Search" (ionInput)="getList()">\n    </ion-searchbar>\n  </ion-toolbar>\n  <!-- <button class="search" (click)="getList()"><ion-icon name="search" class="tool"></ion-icon>Search</button> -->\n  <div *ngIf="itemsList">\n    <ion-list>\n      <div ion-item no-lines *ngFor="let z of itemsList">\n        <p [class]="types"\n         (click)="choose(z)">{{z.text}}</p>\n      </div>\n    </ion-list>\n  </div>\n</ion-content>'/*ion-inline-end:"/mnt/F/Projects/CP/hhcp/src/pages/lookup/lookup.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* LoadingController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
...
var ConnectionProvider = /** @class */ (function () {
    ...
    ConnectionProvider.prototype.checkConnection = function () {
        ...
        var route = this.hhapi.apiURL + "master/";
    ...
    ConnectionProvider = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__angular_common_http__["a" /* HttpClient */],
            __WEBPACK_IMPORTED_MODULE_2__hhapi_hhapi__["a" /* HHAPI */]])
    ], ConnectionProvider);
